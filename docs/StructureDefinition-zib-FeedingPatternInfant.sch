...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation/f:component">
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-FeedingPatternInfant-FeedingMethod']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-FeedingPatternInfant-FeedingMethod': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
