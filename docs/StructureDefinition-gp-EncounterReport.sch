...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Composition/f:section">
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/code-icpc-1-nl']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/code-icpc-1-nl': maximum cardinality of 'extension' is 1</sch:assert>
