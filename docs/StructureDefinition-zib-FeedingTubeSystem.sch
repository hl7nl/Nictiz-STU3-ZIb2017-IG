...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile Zib MedicalDevice
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DeviceUseStatement">
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicalDevice-Organization']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicalDevice-Organization': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicalDevice-Practitioner']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicalDevice-Practitioner': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
