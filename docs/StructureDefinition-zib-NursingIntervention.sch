...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/goal-pertainsToGoal']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/goal-pertainsToGoal': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/procedure-schedule']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/procedure-schedule': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-NursingIntervention-Interval']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-NursingIntervention-Interval': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure/f:extension">
      ...
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:valueTiming) &lt;= 1">valueTiming: maximum cardinality of 'valueTiming' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
