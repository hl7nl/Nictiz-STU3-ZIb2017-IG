...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:NutritionOrder">
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-NutritionAdvice-Explanation']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-NutritionAdvice-Explanation': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:NutritionOrder/f:orderer</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:NutritionOrder/f:oralDiet/f:texture/f:foodType</sch:title>
