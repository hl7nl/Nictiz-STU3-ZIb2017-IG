...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Consent/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'Verified']) &gt;= 1">extension with URL = 'Verified': minimum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Consent/f:period</sch:title>
