...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-Respiration-AdministeredOxygen']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-Respiration-AdministeredOxygen': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    ...
    <sch:rule context="f:Observation/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'extraOxygenAdministration']) &lt;= 1">extension with URL = 'extraOxygenAdministration': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'flowRate']) &lt;= 1">extension with URL = 'flowRate': maximum cardinality of 'extension' is 1</sch:assert>
