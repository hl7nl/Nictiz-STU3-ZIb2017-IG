...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  -->
  <sch:pattern>
    <sch:title>f:DeviceRequest/f:status</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:DeviceRequest/f:status/f:extension</sch:title>
    <sch:rule context="f:DeviceRequest/f:status/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:DeviceRequest/f:requester/f:agent</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:DeviceRequest/f:performerType</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:DeviceRequest/f:performer</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:DeviceRequest/f:note</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:DeviceRequest/f:note/f:author[x] 1</sch:title>
    <sch:rule context="f:DeviceRequest/f:note/f:author[x]">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/practitionerrole-reference']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/practitionerrole-reference': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:reference) &lt;= 1">reference: maximum cardinality of 'reference' is 1</sch:assert>
      <sch:assert test="count(f:identifier) &lt;= 1">identifier: maximum cardinality of 'identifier' is 1</sch:assert>
