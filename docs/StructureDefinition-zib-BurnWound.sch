...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/condition-dateOfLastDressingChange']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/condition-dateOfLastDressingChange': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-BurnWound-Extent']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-BurnWound-Extent': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition/f:code">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-BurnWound-BurnWoundType']) &lt;= 1">extension with URL = 'http://nictiz.nl/fhir/StructureDefinition/zib-BurnWound-BurnWoundType': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Condition/f:code/f:extension</sch:title>
